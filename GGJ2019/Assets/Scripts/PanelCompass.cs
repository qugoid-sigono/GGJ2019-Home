...
public class PanelCompass : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.initialAngle = Mathf.Atan2(dir.y, dir.x) * Mathf.Rad2Deg - Mathf.Rad2Deg;
    }
    ...
    void Update()
    {
        ...
        float angle = Mathf.Atan2(dir.y, dir.x) * Mathf.Rad2Deg - Mathf.Rad2Deg - this.initialAngle;
